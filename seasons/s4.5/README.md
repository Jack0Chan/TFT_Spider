# TFT_Spider — S4.5 瑞兽闹新春

腾讯官方历史静态接口恢复。数据版本 `11.2`，快照日期 `2026-09-17`。

> 强化符文说明：该赛季尚未引入强化符文系统

<img src="readme_images/tft_web.png" width="70%" alt="S4.5 数据概览">
...
python scripts/generate_readme_images.py --season s4.5
```
