# TFT_Spider — S13 双城之战2

仓库历史赛季快照。数据版本 `14.24`，快照日期 `2024-12-19`。

<img src="readme_images/tft_web.png" width="70%" alt="S13 数据概览">
...
python main.py
python scripts/generate_readme_images.py --season s13
```
