...
TFT_RAW_DATA_FILE = os.path.join(ROOT_DIR, 'tft_raw_data.json')
TFT_PROCESSED_DATA_FILE = os.path.join(ROOT_DIR, 'tft_processed_data.json')
TFT_PY_CLASS_FILE = os.path.join(ROOT_DIR, 'TFTData.py')
...
class RawDataCollector:
    ...
    def download_skill_imgs(self) -> None:
        ...
        for chess in track(chess_list, description="正在爬取技能图片"):
            ...
            img_name = f"images/skill/{img_name}"
            img_name = os.path.join(ROOT_DIR, img_name)
